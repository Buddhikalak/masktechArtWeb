							...
							for($i=1; $i<=$photograph_total_feature_tab_tag; $i++){
								...
								foreach ( $photograph_list_tab_tags as $photograph_tag_list) :
									...
									if($i==1){ 
										...
										<li data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_attr($post_tags->name); ?></li>
										<?php } else { ?>
										<li class="active" data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_attr($post_tags->name); ?></li>
										<?php }
									} else { ?>
										<li data-category=".tag-<?php echo esc_attr($photograph_tag_list); ?>"><?php echo esc_attr($post_tags->name); ?></li>
									<?php } 
